...
export const load: ServerLoad = async ({ request }) => {
	...
	const notesWithExtras = notesResult.map((note) => {
		// TODO: Implement fetching attachments and quoted notes from DB relations
		// For now, we return empty/null as the base implementation
		return {
			...note,
			title: note.title ?? '',
